		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#ZUXAV01alisverislistesi-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ZUXAV01alisverislistesi-display": {
								"semanticObject": "ZUXAV01alisverislistesi",
								"action": "display",
								"description": "SAP UI5 Intro App",
								"title": "App Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ZUXAV01.alisverislistesi",
									"url": sap.ui.require.toUrl("ZUXAV01/alisverislistesi")
								}
							}
						}
					}
